...
def test_v2b_css_no_deletion_in_style():
    ...
    EXEMPT = (
        ...
        # V2D6 特批豁免（owner 票钉死）：思考框中性化迁移既有 CSS 值
        ".think-box {",
        ".think-box .think-label {",
        ".think-dot {",
        ".ovl-spinner span {",
        ".v2a-loader .sp span {",
