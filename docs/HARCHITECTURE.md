...
> Version v1.3 (ratified) · 2026-08-23 · Principle 5 amended: reporting must carry architectural coordinates (owner 2026-08-23)
...
- **Reporting must carry architectural coordinates** (owner 2026-08-23): every task/plan/status report MUST state its position in the corridor/room/front-gate frame (or ARCHITECTURE-MAP cells) AND its coupling relations (what it couples with, what it decouples). Flat task lists are prohibited — the report's structure becomes the owner's mental model; a list without coordinates misleads the owner's judgment (origin: owner caught a "5 modules" report that concealed which were corridor-coupled vs independent).
