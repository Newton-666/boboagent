...
> v3.1 · 2026-08-14 · 随每票终审合并滚动更新；发现新问题/新想法 → 补进本文件对应梯队
...
| 2 | COST-1a 外置变量实验（owner 11:38 拍板：**实验最优先，先于样式票**；Worker 冻结） | 外置沙盒：可调 N 工具/N skill/N 段注入 prompt，实测缓存命中率上限与 efficiency×ability 平衡点；核心引擎零改动，报告出来前核心一行不动 | 📋 R3 后启动，详见第二梯队 |
