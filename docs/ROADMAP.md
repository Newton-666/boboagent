...
> v2.5 · 2026-08-14 · 随每票终审合并滚动更新；发现新问题/新想法 → 补进本文件对应梯队
...
| 3 | CORE-R3（P0） | 答复生成链路重做：答复契约进系统提示词（第一句直面问题/分条带实质/证据落盘）+ R2b 闸门扩面到研究/问答/收工回合（owner："快被这个回复折磨疯了"） | 📋 票已写，F10/INT2 后派 |
